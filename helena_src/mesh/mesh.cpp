...
void Mesh::read_xml(const std::string &filename)
{
  ...
  for (pugi::xml_node node = nodes.child("node"); node;
    ...
    arma::vec3 p;
    p(0) = node.attribute("x").as_double()*1e3;
    p(1) = node.attribute("y").as_double()*1e3;
    p(2) = node.attribute("z").as_double()*1e3;
    points.push_back(p);
  }
  ...
  if (celltype == "line") {
    ...
    for (pugi::xml_node elem = elements.child("element"); elem;
      ...
      elems.push_back(Element(ELEM_SEGM, pnum, marker));
    }
  }
  ...
  if (celltype == "triangle") {
    ...
    for (pugi::xml_node elem = elements.child("element"); elem;
      ...
      elems.push_back(Element(ELEM_TRIG, pnum, marker));
    }
  }
  ...
  if (celltype == "quadrilateral") {
    ...
    for (pugi::xml_node elem = elements.child("element"); elem;
      ...
      elems.push_back(Element(ELEM_QUAD, pnum, marker));
    }
  }
  ...
  if (celltype == "tetrahedron") {
    ...
    for (pugi::xml_node elem = elements.child("element"); elem;
      ...
      pnum[2] = elem.attribute("v2").as_int();
      pnum[3] = elem.attribute("v3").as_int();
      elems.push_back(Element(ELEM_TETRA, pnum, marker));
    }
  }
  ...
  if (celltype == "hexahedron") {
    ...
    for (pugi::xml_node elem = elements.child("element"); elem;
      ...
      elems.push_back(Element(ELEM_HEXA, pnum, marker));
